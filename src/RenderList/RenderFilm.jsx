    ...
    renderFilm = () => {
        return arrFilm.map((film, index) => {
            return <div className='col-2 mt-2' key={index}>
                <div className="card">
                    <img src={film.hinhAnh} alt="..." height={350} style={{ objectFit: 'cover' }} />
                    <div className="card-body bg-dark text-white">
                        <h4 style={{ height: 50 }}>{film.tenPhim}</h4>
                        <p className='mt-4' style={{ height: 50 }}>{film.moTa.length > 50 ? film.moTa.substring(0, 50) + '...' : film.moTa}</p>
                    </div>
                </div>
            </div>
        })
    ...
    render() {
        return (
            <div className='background-film'>
                <div style={{ width: '100%', minHeight:'100vh', top: 0, left: 0, background: 'rgba:0,0,0,.5' }}>
