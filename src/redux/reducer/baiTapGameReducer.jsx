const stateDefault = {
    ...
    diemCuoc: true, //true: tài, false:xỉu. Lưu bằng true, false sẽ nhẹ hơn
    soBanThang: 0,
    soLanCuoc: 0,
};
...
export const baiTapGameReducer = (state = stateDefault, action) => {
    switch (action.type) {
        ...
        case 'PLAY_GAME': {
            ...
            let arrXXNN = [];
            for (let i = 0; i<3; i++) {
                // Mỗi lần lặp random tạo ra số ngẫu nhiên
                let soNN = Math.floor(Math.random()*6)+1;
                //Từ số ngẫu nhiên tạo ra các ob xúc xắc ngẫu nhiên
            ...
            if((diem>11 && newState.diemCuoc == true) || (diem<11 && newState.diem == false)){
